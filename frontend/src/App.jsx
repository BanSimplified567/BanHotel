...
import Contact from '@pages/user/Homepage/Contact'; // Import directly
import Home from '@pages/user/Homepage/Home'; // Import directly
import Rooms from '@pages/user/Homepage/Rooms'; // Import directly
import Facilities from '@pages/user/RoomFacilities/Facilities'; // Import directly
